...
def CloneSource(inDocker){
      ...
      currentUISum = sh(returnStdout: true, script: 'find js/apps/system/_admin/aardvark/APP/frontend/ -path js/apps/system/_admin/aardvark/APP/frontend/build -prune -o -type f -exec md5sum {} \\; | sort -k 2 | md5sum')
